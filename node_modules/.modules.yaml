...
hoistedDependencies:
  ...
  fsevents@2.3.3:
    fsevents: private
  gateway/nginx:
    '@campus/gateway': private
  nanoid@3.3.11:
    nanoid: private
  observability/grafana:
    '@campus/grafana': private
  observability/prometheus:
    '@campus/prometheus': private
  picocolors@1.1.1:
    picocolors: private
  picomatch@4.0.3:
    picomatch: private
  ...
  services/auth-service:
    '@campus/auth-service': private
  services/chat-service:
    '@campus/chat-service': private
  services/delivery-service:
    '@campus/delivery-service': private
  services/item-service:
    '@campus/item-service': private
  services/notification-service:
    '@campus/notification-service': private
  services/reputation-service:
    '@campus/reputation-service': private
  services/reservation-service:
    '@campus/reservation-service': private
  services/search-service:
    '@campus/search-service': private
  services/traceability-service:
    '@campus/traceability-service': private
  services/user-service:
    '@campus/user-service': private
  source-map-js@1.2.1:
...
pendingBuilds: []
prunedAt: Sat, 17 Jan 2026 21:39:16 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - turbo-linux-arm64@2.7.2
  - turbo-windows-arm64@2.7.2
storeDir: C:\Users\Erick\AppData\Local\pnpm\store\v3
virtualStoreDir: C:\Users\Erick\Documents\Projects\CampusUCETrade\node_modules\.pnpm
